...
@RequestMapping("/api/core/action")
public class UserController extends BaseController {
	...
	String  login(HttpServletRequest request) throws Exception
	{
		...
		if( dbPassword.length()>0 && dbPassword.equals(password) )
		{
			...
			String credit_card_type=userRow.getString("credit_card_type","");
			String address=userRow.getString("address","");
			// 1房东2租客3既是房东又是租客
			String type=userRow.getString("type","");
...
//		String bank_card_no =ivo.getString("bank_card_no",null);
//		if(!StringUtils.isEmptyOrNull(bank_card_no))
//		{
//			userRow.put("bank_card_no", bank_card_no);
//		}
//		String credit_card_no =ivo.getString("credit_card_no",null);
//		if(!StringUtils.isEmptyOrNull(credit_card_no))
//		{
...
//			old_id_card_no
	...
	String resetPasswordByEmail(HttpServletRequest request) throws Exception
	{
		...
		//验证姓名、邮箱是否正确
		Row userRow =userService.findByEmail(email);
		if(userRow == null)
		{
