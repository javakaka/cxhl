...
//		String sms_content ="欢迎使用吃香喝辣,您的验证码是:"+sms_code+"【房不剩房】";
		String sms_content ="吃香喝辣注册验证码为："+sms_code+"，请在5分钟内完成验证。如非本机号码操作，请忽略此信息。【吃香喝辣】";
...
//		}
		int sms_code =NumberUtils.getSixRandomNumber();
//		String sms_content ="欢迎使用吃香喝辣,您的验证码是:"+sms_code+"【房不剩房】";
		String sms_content ="吃香喝辣找回密码的验证码为："+sms_code+"，请在5分钟内完成验证。如非本机号码操作，请忽略此信息。【吃香喝辣】";
		//0发送失败 1发送成功 2已过期 -1本地测试短信，不发送
		int status =0;
		//调用第三方短信平台接口
		long remote_send_status =0;
...
//		}
		int sms_code =NumberUtils.getSixRandomNumber();
//		String sms_content ="欢迎使用吃香喝辣,您的验证码是:"+sms_code+"【房不剩房】";
		String sms_content ="吃香喝辣更换手机号码的验证码为："+sms_code+"，请在5分钟内完成验证。如非本机号码操作，请忽略此信息。【吃香喝辣】";
		//0发送失败 1发送成功 2已过期 -1本地测试短信，不发送
		int status =0;
		//调用第三方短信平台接口
		long remote_send_status =0;
