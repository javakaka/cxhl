...
public class UserService extends Service{
	...
	{
		Row row =null;
		String sSql =" select * from cxhl_users where ( username='"+username+"'  or telephone='"+username+"' )";
		row =queryRow(sSql);
		return row;
	}
	...
	{
		Row row =null;
		String sSql =" select * from cxhl_users where  telephone='"+telephone+"' ";
		row =queryRow(sSql);
		return row;
	}
	...
	{
		int total=0;
		String sSql =" select count(*) from cxhl_users ";
	...
	{
		Row row =null;
		String sSql =" select * from cxhl_users where  username='"+username+"' ";
		row =queryRow(sSql);
		return row;
	}
	...
	{
		Row row =null;
		String sSql =" select * from cxhl_users where invite_code='"+invite_code+"' ";
		row =queryRow(sSql);
		return row;
	}
	...
	{
		boolean bool =false;
		String sSql =" select count(*) from cxhl_users where user_code='"+user_code+"' ";
	...
	{
		Row row =null;
		String sSql =" select * from cxhl_users where  email='"+email+"' ";
		row =queryRow(sSql);
		return row;
	}
	...
	{
		Row row =null;
		String sSql =" select * from cxhl_users where id='"+id+"' ";
		row =queryRow(sSql);
		return row;
	}
	...
	{
		int num =0;
		int id =getTableSequence("cxhl_users", "id", 1);
		row.put("id", id);
		num =insert("cxhl_users", row);
		return num;
	}
	...
	public int update(Row row)
	{
		...
		num =update("cxhl_users", row, " id='"+id+"'");
		return num;
	}
	...
	public Page queryPage() {
		...
		sql = "select * from cxhl_users where 1=1 ";
		String restrictions = addRestrictions(pageable);
		String orders = addOrders(pageable);
		sql += restrictions;
		sql += orders;
		String countSql = "select count(*) from cxhl_users where 1=1 ";
	...
	public DataSet queryLatestTop5Users() {
		...
		String sql="select * from cxhl_users order by create_time desc limit 0,5 ";
		dataSet =queryDataSet(sql);
	...
	{
		int status =0;
		String sSql ="select * from cxhl_users where id='"+user_id+"'";
		...
		else
		{
			...
			{
				sSql ="update cxhl_users set password='"+newPwd+"' where id='"+user_id+"'";
	...
	public boolean isEmailExisted(String id,String email)
	{
		...
		String sSql =" select count(*) from cxhl_users where  email='"+email+"' and id !='"+id+"'";
	...
	{
		boolean existed =false;
		String sSql =" select count(*) from cxhl_users where  username='"+username+"' and id !='"+id+"'";
		String num =queryField(sSql);
		if(Integer.parseInt(num)>0)
		{
			existed =true;
	...
	public void delete(Long... ids) {
		...
		if (ids != null) {
			...
			sql = "delete from cxhl_users where id in(" + id + ")";
			update(sql);
		}
	}
	...
	public void resetPassword(String id) {
		...
		sql = "update cxhl_users set password='"+password+"'  where id='"+id+"'";
	...
	{
		boolean bool =true;
		String sql ="select count(*) from cxhl_users where telephone ='"+telephone+"'";
	...
	{
		boolean bool =true;
		String sql ="select count(*) from cxhl_users where email ='"+email+"'";
		String count =queryField(sql);
		int sum =Integer.parseInt(count);
		if(sum >0)
			bool =false;
	...
	{
		boolean bool =true;
		String sql ="select count(*) from cxhl_users where email ='"+email+"' and id !='"+id+"'";
		String count =queryField(sql);
		int sum =Integer.parseInt(count);
		if(sum >0)
			bool =false;
	...
	{
		boolean bool =true;
		String sql ="select count(*) from cxhl_users where id_card_no ='"+id_card_no+"'";
		String count =queryField(sql);
		int sum =Integer.parseInt(count);
		if(sum >0)
			bool =false;
	...
	{
		boolean bool =true;
		String sql ="select count(*) from cxhl_users where id_card_no ='"+id_card_no+"' and id !='"+id+"'";
		String count =queryField(sql);
		int sum =Integer.parseInt(count);
		if(sum >0)
			bool =false;
	...
	{
		boolean bool =true;
		String sql ="select count(*) from cxhl_users where bank_card_no ='"+bank_card_no+"' and id !='"+id+"'";
		System.out.println("sql--------->>"+sql);
		String count =queryField(sql);
		int sum =Integer.parseInt(count);
		if(sum >0)
	...
	{
		boolean bool =true;
		String sql ="select count(*) from cxhl_users where credit_card_no ='"+credit_card_no+"' and id !='"+id+"'";
		System.out.println("sql--------->>"+sql);
		String count =queryField(sql);
		int sum =Integer.parseInt(count);
		if(sum >0)
	...
	{
		boolean bool =false;
		String sql ="select count(*) from cxhl_users where id !='"+user_id+"' and id_card_no='"+id_card_no+"' ";
		String count =queryField(sql);
		int sum =Integer.parseInt(count);
		if(sum >0)
			bool =true;
