	...
	<form id="listForm" action="list.do" method="get">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'C_NAME'}"> class="current"</c:if> val="C_NAME">商家名称</a>
						</li>
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'LINK_NAME'}">class="current"</c:if> val="LINK_NAME">联系人</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="C_NAME">商家名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="LINK_NAME">联系人</a>
				</th>
				<th>
				...
				<th>
					<a href="javascript:;" class="sort" name="ZONE_NAME">区域</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<span title="${row.C_NAME}">${row.C_NAME}</span>
					</td>
					<td>
						<span title="${row.LINK_NAME}">${row.LINK_NAME}</span>
					</td>
					<td>
