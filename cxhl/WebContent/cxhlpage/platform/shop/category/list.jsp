	...
	<form id="listForm" action="list.do" method="get">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'TELEPHONE'}"> class="current"</c:if> val="TELEPHONE">会员手机号码</a>
						</li>
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'USERNAME'}">class="current"</c:if> val="USERNAME">会员姓名</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="NAME">分类名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="LEVEL_INDEX">排序</a>
				</th>
				<!-- <th>
					<a href="javascript:;" class="sort" name="FILE_PATH">图标</a>
				</th>
				-->
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<span title="${row.LEVEL_INDEX}">${row.LEVEL_INDEX}</span>
					</td>
					<!-- <td>
						<span title="${row.FILE_PATH}">${row.FILE_PATH}</span>
					</td>
					-->
					<td>
