...
<body>
	...
	<form id="listForm" action="SelectCoupon.do" method="get">
		<div class="bar">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="SHOP_NAME">所属商家</a>
				</th>
				<th>
...
function selectTarget(){
	...
	window.parent.setSelectedCoupon(selectedId,target);
...
function addEventHandlers()
{
	...
	if(typeof is_window_bottom_existed =="undefined" || is_window_bottom_existed == null || is_window_bottom_existed == "")
	{
		...
		b_div.innerHTML="";
		var html="<div style=\"float:right;\"><input type=\"button\" name=\"submitBtn\" id=\"submitBtn\" value=\"确定\" class=\"button\" onclick=\"couponIframeSelectTarget()\"/></div>";
